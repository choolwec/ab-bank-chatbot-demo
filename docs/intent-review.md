...
**53 intents. ALL ANSWERS ARE DRAFTS** — nothing launches until every item below is signed off (build plan §3.5) and every `[CONFIRM …]` placeholder is resolved.
...
> That's not something I can help with here. I can help with accounts,
> eTumba, loans and branches, or connect you to our team.

Plainer version (sent for "what do you mean?"):

> I can't help with that. I can help with accounts, eTumba, loans and branches.

Follow-up buttons: Open an account · eTumba · Loans · Branches & agents · Talk to a person
...
> This is the AB Bank automated assistant. I've logged your message as urgent for our team — your reference is {ref}. If your card is lost or money was taken without your permission, call {emergency_phone} now to block it. Never share your PIN.

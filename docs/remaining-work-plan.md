...
| 21 | `guards.yes_no` counts loose replies such as "sure" as marketing consent. Does that meet the ECT Act 2021 opt-in standard? | Legal | PO decided 24/09 (D16): anything that means yes is consent; qualified answers re-ask. Legal to confirm against the ECT Act 2021 |
